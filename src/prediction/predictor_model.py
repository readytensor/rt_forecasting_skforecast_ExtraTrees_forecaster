...
class Forecaster:
    """A wrapper class for the ExtraTrees Forecaster.

    This class provides a consistent interface that can be used with other
    Forecaster models.
    """

    model_name = "ExtraTrees Forecaster"
    ...
    def __init__(
        ...
        """Construct a new ExtraTrees Forecaster
    ...
    def fit(
        ...
        A separate ExtraTrees model is fit to each series that is contained
        in the data.
