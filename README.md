# Extra Trees Forecaster in Skforecast

Extra Trees Forecaster for the Forecasting problem category as per Ready Tensor specifications.
...
- A **Extra Trees Forecaster** algorithm built using **Skforecast**
